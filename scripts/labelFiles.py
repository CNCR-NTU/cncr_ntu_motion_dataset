...
for j in range(0,6):
    ...
    for i in range (1,501):
        url2read = os.path.expanduser('~') + '/Development/cncr_object_motion_dataset/naturalDataSet/raw_objects/'+movement+"/seq"+str(i)+ '/'
        url2write = os.path.expanduser('~') + '/Development/cncr_object_motion_dataset/naturalDataSet/raw_objects/'+movement+"/seq"+str(i)+ '/'
