...
for j in range(0,4):
    ...
    for i in range (1,101):
        if j==0:
            folder = 'newDataSet/rawImages/HzMovSet'+str(i)
        else:
            folder = 'newDataSet/right/rightMovSet' + str(i)
        url = os.getcwd() + '/' + folder + '/'
        url2write = os.getcwd() + '/' + "newDataSet/"+movement+"/"+movement+"MovSet"+str(i)+ '/'
